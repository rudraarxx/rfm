    ...
    <section className="relative px-6 pt-24 pb-16 flex flex-col items-center text-center overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-lg space-y-12">
        ...
        >
          ...
          <span className="text-[11px] font-bold uppercase tracking-[0.4em] text-brass/80">
            Live Nagpur Pulse
          </span>
        </motion.div>
        ...
        <div className="space-y-6">
          <div className="relative">
            <motion.h1
              ...
              className="text-7xl font-primary tracking-tighter text-white leading-[0.9]"
            >
              Nagpur
              <br />
              <span className="text-white/10 italic font-light">Pulse.</span>
            </motion.h1>
            {/* Reflective Accents */}
          ...
          <motion.p
            ...
            className="text-lg text-white/40 font-medium max-w-[280px] mx-auto leading-relaxed font-sans"
          >
            Curated Radio Shell for the <span className="text-white/60">Analog Soul.</span>
          </motion.p>
        </div>
        ...
        >
          <div className="flex items-center gap-5 px-6 py-4 rounded-2xl glass border border-white/5 shadow-2xl">
            ...
            <div className="text-left space-y-0.5">
              ...
              <p className="text-[9px] text-white/30 font-bold uppercase tracking-[0.2em] flex items-center gap-2">
