        ...
        children: [
          ...
          if (radioState.currentStation != null && currentIndex != 1) // Hide on PlayerScreen
            Positioned(
              left: 0,
              right: 0,
              bottom: 64, // Floating above navigation bar
          ...
          Positioned(
            ...
            child: Container(
              ...
              child: Row(
                ...
                children: [
                  _buildNavItem(context, ref, Icons.bolt_rounded, 'FORGE', 0, currentIndex == 0),
                  _buildNavItem(context, ref, Icons.waves_rounded, 'WAVES', 1, currentIndex == 1),
                  _buildNavItem(context, ref, Icons.radar_rounded, 'SCAN', 2, currentIndex == 2),
                ],
              ),
            ),
          ),
